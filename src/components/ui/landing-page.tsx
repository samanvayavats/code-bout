    ...
    <main>
      ...
      <section className='relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-28 pb-20 overflow-hidden'>
        ...
        <h1 className='text-[clamp(48px,7vw,96px)] font-bold leading-none tracking-[-2px] mb-6'>
          Code Faster.
          <br />
          Think <em className='not-italic text-[#E63946]'>Sharper.</em>
          <br />
          Win Live.
        </h1>
      ...
      <div className='flex justify-center border-t border-b border-[#1E1E2E] bg-[#111118]'>
        {[
          ...
          >
            <div className='font-mono text-4xl font-semibold text-[#E63946] leading-none'>
              {s.num}
            </div>
        ...
        <div className='w-full max-w-4xl border border-[#1E1E2E] rounded-xl overflow-hidden bg-[#111118]'>
          ...
          <div className='flex items-center justify-between px-5 py-3 border-b border-[#1E1E2E] bg-[#E63946]/5'>
            <div className='flex items-center gap-3'>
              ...
              <span className='font-mono text-[11px] font-semibold text-[#6B6B80] px-2 py-1 border border-[#1E1E2E] rounded'>
                VS
              </span>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2'>
            ...
            <div className='p-6 border-b md:border-b-0 md:border-r border-[#1E1E2E]'>
              ...
              <div className='bg-[#0A0A0F] rounded-md p-3 font-mono text-xs text-white leading-loose'>
                <div>
                  <span className='text-[#6B6B80]'>Input: </span>nums = [2,7,11,15], target = 9
                </div>
                <div>
                  <span className='text-[#6B6B80]'>Output: </span>[0,1]
                </div>
              </div>
            </div>
            ...
            <div>
              <div className='flex items-center justify-between px-4 py-2 border-b border-[#1E1E2E]'>
                ...
                <button className='text-xs font-semibold px-4 py-1.5 rounded bg-[#E63946] text-white'>
                  ▶ Run
                </button>
              </div>
              <div className='p-4 font-mono text-xs leading-loose text-[#ABB2BF] bg-[#0A0A0F] min-h-[200px]'>
                <div>
                  ...
                  <span className='text-[#61AFEF]'>twoSum</span>(nums, target) {'{'}
                </div>
                <div>
                  &nbsp;&nbsp;<span className='text-[#C678DD]'>const</span> map ={' '}
                  <span className='text-[#C678DD]'>new</span>{' '}
                  <span className='text-[#61AFEF]'>Map</span>();
                </div>
                <div>
                  &nbsp;&nbsp;<span className='text-[#C678DD]'>for</span> (
                  <span className='text-[#C678DD]'>let</span> i ={' '}
                  <span className='text-[#D19A66]'>0</span>; i {'<'} nums.length; i++) {'{'}
                </div>
                <div>
                  &nbsp;&nbsp;&nbsp;&nbsp;<span className='text-[#C678DD]'>const</span> comp =
                  target - nums[i];
                </div>
                <div>
                  &nbsp;&nbsp;&nbsp;&nbsp;<span className='text-[#C678DD]'>if</span> (map.
                  <span className='text-[#61AFEF]'>has</span>(comp))
                </div>
                <div>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className='text-[#C678DD]'>return</span>{' '}
                  [map.<span className='text-[#61AFEF]'>get</span>(comp), i];
                </div>
                <div>
                  &nbsp;&nbsp;&nbsp;&nbsp;map.<span className='text-[#61AFEF]'>set</span>(nums[i],
                  i);
                </div>
                <div>&nbsp;&nbsp;{'}'}</div>
                <div>{'}'}</div>
          ...
          {[
            {
              icon: '✓',
              name: 'Correctness',
              desc: 'All hidden test cases must pass. Wrong answer = 0 points.',
              bar: 'bg-[#E63946] w-full',
            },
            {
              icon: '⚡',
              name: 'Speed',
              desc: 'Faster execution time earns bonus points on top.',
              bar: 'bg-[#F4D03F] w-[70%]',
            },
            {
              icon: '💾',
              name: 'Memory',
              desc: 'Lower memory usage breaks ties between equal scores.',
              bar: 'bg-[#2ECC71] w-[50%]',
            },
          ].map((s) => (
            <div
              key={s.name}
              className='flex-1 min-w-[180px] bg-[#111118] border border-[#1E1E2E] rounded-xl p-7 text-center'
            >
      ...
      <section className='relative border-t border-[#1E1E2E] px-12 py-32 text-center overflow-hidden'>
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 50% 60% at 50% 100%, rgba(230,57,70,0.1), transparent 70%)',
          }}
        />
        <h2 className='text-[clamp(36px,5vw,64px)] font-bold tracking-[-2px] mb-4'>
          Ready to duel?
        </h2>
        <p className='text-base text-[#6B6B80] mb-10'>
          Find your opponent. Write your code. Win the match.
        </p>
        <Link
          href='/problems'
